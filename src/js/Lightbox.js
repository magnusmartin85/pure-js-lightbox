...
class Lightbox {
    ...
    hideBackdrop() {
        document
            .querySelector("." + CLASSNAME_BACKDROP)
            .classList.replace(CLASSNAME_SHOW, CLASSNAME_HIDE);
    }

    showBackdrop() {
        document
            .querySelector("." + CLASSNAME_BACKDROP)
            .classList.replace(CLASSNAME_HIDE, CLASSNAME_SHOW);
    }
    ...
    setImageSource(currentImageIndex) {
        ...
        if (typeof sourceText !== "undefined") {
            document.querySelector(".lightbox-overlay-image-source").textContent =
                sourceText;
        }
    }
